...
extern size_t   I2C_Write(dev_t dev, void *src, size_t size, size_t nitems, size_t seek);
extern size_t   I2C_Read(dev_t dev , void *dst, size_t size, size_t nitems, size_t seek);
