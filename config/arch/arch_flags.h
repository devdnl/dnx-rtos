...
#     uC.PERIPH["STM32H7A3LGxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3NGxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3QGxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3RGxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3VGxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3VGxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3ZGxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3ZGxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3AIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3IIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3IIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3LIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3NIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3QIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3RIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3VIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3VIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3ZIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7A3ZIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0ABxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0IBKxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0IBxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0RBxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0VBxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B0ZBxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3AIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3IIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3IIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3LIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3NIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3QIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3RIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3VIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3VIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3ZIxx" ]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
#     uC.PERIPH["STM32H7B3ZIxxQ"]={GPIO=true, CLK=true, AFM=true, DMA=true, UART=true, I2C=true, SDMMC=true, EMI=true, LTDC=true}
# end
#++*/
...
#/*--
# if uC.PERIPH[uC.NAME].SDMMC ~= nil then
#     this:PutWidgets("SDMMC", "arch/"..uC.ARCH.."/sdmmc_flags.h")
#     this:SetToolTip("SD/MMC driver")
# else
#     this:AddWidget("Value")
#     this:SetFlagValue("__ENABLE_SDMMC__", "_NO_")
# end
#--*/
#define __ENABLE_SDMMC__ _NO_
#/*
