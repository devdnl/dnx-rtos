...
/*--
this:SetLayout("TitledGridBack", 2, "Home > Microcontroller > AFIO",
...
--*/
#define __AFIO_REMAP_USART2__ 1
...
--*/
#define __AFIO_REMAP_MII_RMII_SEL__ 1
