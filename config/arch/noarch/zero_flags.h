...
#ifndef _ZERO_FLAGS_H_
#define _ZERO_FLAGS_H_

/*--
this:SetLayout("TitledGridBack", 2, "Home > Microcontroller > ZERO",
...
--*/
#define __ZERO_CFG_EXAMPLE__ _NO_

#endif /* _ZERO_FLAGS_H_ */
/*==============================================================================
  End of file
==============================================================================*/
