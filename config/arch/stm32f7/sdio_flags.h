...
--*/
#define __SDIO_CFG_SDMMC1_CLOCK_EDGE__ SDMMC_CLOCK_EDGE_RISING
...
--*/
#define __SDIO_CFG_SDMMC1_HW_FLOW_CTRL__ SDMMC_HARDWARE_FLOW_CONTROL_ENABLE
...
--*/
#define __SDIO_CFG_SDMMC1_BUS_WIDE__ SDMMC_BUS_WIDE_4B

/*--
this:AddWidget("Spinbox", 1, 256, "Clock divide factor")
--*/
#define __SDIO_CFG_SDMMC1_CKDIV__ 1

/*--
this:AddWidget("Spinbox", 100, 2000, "Card operation timeout [ms]")
--*/
#define __SDIO_CFG_SDMMC1_CARD_TIMEOUT__ 500
...
--*/
#define __SDIO_CFG_SDMMC1_PWRSAVE__ SDMMC_CLOCK_POWER_SAVE_DISABLE
...
--*/
#define __SDIO_CFG_SDMMC1_MODE__ _SDIO_MODE_IRQ

/*--
this:AddWidget("Combobox", "IRQ priority")
uC.AddPriorityItems(this, false)
--*/
#define __SDIO_CFG_SDMMC1_IRQ_PRIORITY__ __CPU_DEFAULT_IRQ_PRIORITY__
...
this:AddItem("SDIO_CK generated on falling edge", "SDMMC_CLOCK_EDGE_FALLING")
--*/
#define __SDIO_CFG_SDMMC2_CLOCK_EDGE__ SDMMC_CLOCK_EDGE_RISING
...
this:AddItem("Enable", "SDMMC_HARDWARE_FLOW_CONTROL_ENABLE")
--*/
#define __SDIO_CFG_SDMMC2_HW_FLOW_CTRL__ SDMMC_HARDWARE_FLOW_CONTROL_ENABLE
...
this:AddItem("4-bit wide bus", "SDMMC_BUS_WIDE_4B")
--*/
#define __SDIO_CFG_SDMMC2_BUS_WIDE__ SDMMC_BUS_WIDE_4B

/*--
this:AddWidget("Spinbox", 1, 256, "Clock divide factor")
--*/
#define __SDIO_CFG_SDMMC2_CKDIV__ 1

/*--
this:AddWidget("Spinbox", 100, 2000, "Card operation timeout [ms]")
--*/
#define __SDIO_CFG_SDMMC2_CARD_TIMEOUT__ 500
...
this:AddItem("Enable", "SDMMC_CLOCK_POWER_SAVE_ENABLE")
--*/
#define __SDIO_CFG_SDMMC2_PWRSAVE__ SDMMC_CLOCK_POWER_SAVE_DISABLE
...
this:AddItem("DMA", "_SDIO_MODE_DMA")
--*/
#define __SDIO_CFG_SDMMC2_MODE__ _SDIO_MODE_IRQ

/*--
this:AddWidget("Combobox", "IRQ priority")
uC.AddPriorityItems(this, false)
--*/
#define __SDIO_CFG_SDMMC2_IRQ_PRIORITY__ __CPU_DEFAULT_IRQ_PRIORITY__
