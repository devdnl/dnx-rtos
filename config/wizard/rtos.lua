...
--------------------------------------------------------------------------------
function configure_task_stack_depth()
...
--------------------------------------------------------------------------------
function configure_fs_stack_depth()
...
--------------------------------------------------------------------------------
function configure_irq_stack_depth()
...
--------------------------------------------------------------------------------
function configure_number_of_priorities()
...
--------------------------------------------------------------------------------
function configure_task_name_length()
...
--------------------------------------------------------------------------------
function configure_context_switch_freq()
...
--------------------------------------------------------------------------------
function configure_sleep_on_idle()
...
--------------------------------------------------------------------------------
function configure_printf_enable()
...
--------------------------------------------------------------------------------
function configure_scanf_enable()
...
--------------------------------------------------------------------------------
function configure_printk_enable()
...
--------------------------------------------------------------------------------
function configure_colorterm_enable()
...
--------------------------------------------------------------------------------
function configure_stream_buffer_length()
...
--------------------------------------------------------------------------------
function configure_pipe_buffer_length()
...
--------------------------------------------------------------------------------
function configure_errno_beauty()
...
--------------------------------------------------------------------------------
function configure_monitor_task_memory_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_task_file_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_kernel_memory_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_module_memory_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_system_memory_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_cpu_load()
...
--------------------------------------------------------------------------------
function configure_monitor_network_memory_usage()
...
--------------------------------------------------------------------------------
function configure_monitor_network_memory_usage_limit()
        local choice = key_read("../project/flags.h", "__OS_MONITOR_NETWORK_MEMORY_USAGE__")
        if (choice == yes) then
                local value = key_read("../project/flags.h", "__OS_MONITOR_NETWORK_MEMORY_USAGE_LIMIT__")
                msg(progress() .. "Configure a limit for memory usage for network layer. To disable this limit enter 0.")
                msg("Current limit is: " .. value .. " bytes.")
...
--------------------------------------------------------------------------------
-- @brief Function return number of steps
--------------------------------------------------------------------------------
function rtos_get_number_of_steps()
        calculate_total_steps()
        return total_cfg
end

--------------------------------------------------------------------------------
-- @brief Function execute RTOS configuration
--------------------------------------------------------------------------------
function rtos_configure()
        current_cfg = 1
        title("Operating System Configuration")
        calculate_total_steps()
        configure_task_stack_depth()
        ...
        configure_monitor_network_memory_usage_limit()
        configure_hostname()
