...
local function calculate_total_steps()
        ...
        if key_read("../project/Makefile", "ENABLE_UART") == yes then
...
local function ask_for_enable()
        local choice = key_read("../project/flags.h", "__ENABLE_UART__")
        ...
        if can_be_saved(choice) then
                key_save("../project/flags.h", "__ENABLE_UART__", choice)
                key_save("../project/Makefile", "ENABLE_UART", choice)
        end
...
arch.stm32f1.configure = function()
        ...
        local function configure_uart_if_enable(uart)
                ...
                local choice = key_read("../stm32f1/uart_flags.h", key)
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", key, choice)
                end
        ...
        local function configure_rx_buffer_len()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_RX_BUFFER_LEN__")
                ...
                if (can_be_saved(choice)) then
                        key_save("../stm32f1/uart_flags.h", "__UART_RX_BUFFER_LEN__", choice)
                end
        ...
        local function configure_parity()
                ...
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_PARITY__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_PARITY__", choice)
                end
        ...
        local function configure_stop_bits()
                ...
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_STOP_BITS__")
                if value[choice] == nil then choice = "Unknown" end
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_STOP_BITS__", choice)
                end
        ...
        local function configure_lin_break_len()
                ...
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_BREAK_LEN__")
                if value[choice] == nil then choice = "Unknown" end
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_BREAK_LEN__", choice)
                end
        ...
        local function configure_tx_enable()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_TX_ENABLE__")
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_TX_ENABLE__", choice)
                end
        ...
        local function configure_rx_enable()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_RX_ENABLE__")
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_RX_ENABLE__", choice)
                end
        ...
        local function configure_lin_mode_enable()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_MODE_ENABLE__")
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_MODE_ENABLE__", choice)
                end
        ...
        local function configure_hw_flow_ctr()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_HW_FLOW_CTRL__")
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_HW_FLOW_CTRL__", choice)
                end
        ...
        local function configure_single_wire_mode()
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_SINGLE_WIRE_MODE__")
                ...
                choice = get_selection()
                if can_be_saved(choice) then
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_SINGLE_WIRE_MODE__", choice)
                end
        ...
        local function configure_baud()
                ...
                local choice = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_BAUD__")
                ...
                if can_be_saved(choice) then
                        ...
                        key_save("../stm32f1/uart_flags.h", "__UART_DEFAULT_BAUD__", baud[choice])
                end
        ...
        local function uart_select()
                local uart_no = db:get_mcu_module_data(cpu:get_name(), "UART")[1]
                ...
                while true do
                        ...
                        if key_read("../stm32f1/uart_flags.h", "__UART_UART"..choice.."_ENABLE__") == yes then
        ...
        local function print_summary()
                local baud       = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_BAUD__")
                local single     = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_SINGLE_WIRE_MODE__")
                local hw_ctrl    = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_HW_FLOW_CTRL__")
                local lin_mode   = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_MODE_ENABLE__")
                local rx_en      = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_RX_ENABLE__")
                local tx_en      = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_TX_ENABLE__")
                local lin_break  = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_LIN_BREAK_LEN__")
                local stop_bits  = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_STOP_BITS__")
                local parity     = key_read("../stm32f1/uart_flags.h", "__UART_DEFAULT_PARITY__")
                local rx_buf_len = key_read("../stm32f1/uart_flags.h", "__UART_RX_BUFFER_LEN__")
                local uart_no    = db:get_mcu_module_data(cpu:get_name(), "UART")[1]
                ...
                msg("Defaults:\n"..
                    ...
                    "  RX Line enabled: "..filter_yes_no(single).."\n"..
                    "  TX Line enabled: "..filter_yes_no(single).."\n"..
                    "  RX buffer length: "..rx_buf_len.." bytes\n"..
                    "  Hardware flow control: "..filter_yes_no(single).."\n"..
                    "  Single wire mode: "..filter_yes_no(single).."\n"..
                    "  LIN mode: "..filter_yes_no(single).."\n"..
                    "  LIN break length: "..lin_break:gsub("UART_LIN_BREAK_", ""):gsub("_BITS", "").." bits\n")

                for uart = 1, uart_no do
                        local enabled  = key_read("../stm32f1/uart_flags.h", "__UART_UART"..uart.."_ENABLE__")
                        local priority = key_read("../stm32f1/uart_flags.h", "__UART_UART"..uart.."_PRIORITY__")
...
function uart:configure()
        title("UART module configuration for " .. cpu:get_name())
        navigation("Home/Modules/UART")
        calculate_total_steps()
