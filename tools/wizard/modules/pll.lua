...
local function ask_for_enable()
        local choice = key_read(db.path.project.flags, "__ENABLE_PLL__")
        ...
        if can_be_saved(choice) then
                key_save(db.path.project.flags, "__ENABLE_PLL__", choice)
                key_save(db.path.project.mk, "ENABLE_PLL", choice)
        end
...
arch.stm32f1.get_frequencies = function()
        ...
        local pll_source        = key_read(db.path.stm32f1.pll.flags, pll_src_key)
        local pll_mull          = key_read(db.path.stm32f1.pll.flags, pll_mull_key):gsub("6_5", "6.5"):gsub("RCC_PLLMul_", "")
        local sysclk_source     = key_read(db.path.stm32f1.pll.flags, "__PLL_SYS_CLK_SRC__")
        local prediv1_source    = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_SRC__")
        local RTC_source        = key_read(db.path.stm32f1.pll.flags, "__PLL_RTC_CLK_SRC__")
        local I2S2_source       = key_read(db.path.stm32f1.pll.flags, "__PLL_I2S2_SRC__")
        local I2S3_source       = key_read(db.path.stm32f1.pll.flags, "__PLL_I2S3_SRC__")
        local prediv1_factor    = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_VAL__"):gsub("RCC_PREDIV1_Div", "")
        local prediv2_factor    = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV2_VAL__"):gsub("RCC_PREDIV2_Div", "")
        local pll2_mull         = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL2_MULL__"):gsub("RCC_PLL2Mul_", "")
        local pll3_mull         = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL3_MULL__"):gsub("RCC_PLL3Mul_", "")
        local AHB_prescaler     = key_read(db.path.stm32f1.pll.flags, "__PLL_AHB_PRE__"):gsub("RCC_SYSCLK_Div", "")
        local APB1_prescaler    = key_read(db.path.stm32f1.pll.flags, "__PLL_APB1_PRE__"):gsub("RCC_HCLK_Div", "")
        local APB2_prescaler    = key_read(db.path.stm32f1.pll.flags, "__PLL_APB2_PRE__"):gsub("RCC_HCLK_Div", "")
        local ADC_prescaler     = key_read(db.path.stm32f1.pll.flags, "__PLL_ADC_PRE__"):gsub("RCC_PCLK2_Div", "")
        local USB_prescaler     = key_read(db.path.stm32f1.pll.flags, usb_div_key):gsub("1Div5", "Div1.5"):gsub("RCC_.*CLKSource_PLL.*_Div", "")
        local MCO_source        = key_read(db.path.stm32f1.pll.flags, mco_src_key)

        local freq              = {}
        freq.HSE                = tonumber(key_read(db.path.project.flags, "__CPU_OSC_FREQ__"))
        freq.HSI                = 8e6
        freq.LSI                = 40e3
        freq.LSE                = 32768
        freq.SYSCLK             = 0
...
arch.stm32f1.configure = function()
        ...
        local function configure_flash_latency()
                ...
                key_save(db.path.stm32f1.pll.flags, "__PLL_FLASH_LATENCY__", flash_latency)
        end
        ...
        local function configure_LSI_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_LSI_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_LSI_ON__", choice)
                end
        ...
        local function configure_LSE_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_LSE_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_LSE_ON__", choice)
                end
        ...
        local function configure_HSE_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_HSE_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_HSE_ON__", choice)
                end
        ...
        local function configure_RTC_clk_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_RTC_CLK_SRC__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_RTC_CLK_SRC__", choice)
                end
        ...
        local function configure_sys_clk_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_SYS_CLK_SRC__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_SYS_CLK_SRC__", choice)
                end
        ...
        local function configure_MCO_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, key)
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, key, choice)
                end
        ...
        local function configure_I2S2_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_I2S2_SRC__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_I2S2_SRC__", choice)
                end
        ...
        local function configure_I2S3_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_I2S3_SRC__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_I2S3_SRC__", choice)
                end
        ...
        local function configure_PLL_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PLL_ON__", choice)
                end
        ...
        local function configure_prediv1_src()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_SRC__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_SRC__", choice)
                end
        ...
        local function configure_prediv1_val()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_VAL__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PREDIV1_VAL__", choice)
                end
        ...
        local function configure_prediv2_val()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PREDIV2_VAL__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PREDIV2_VAL__", choice)
                end
        ...
        local function configure_PLL2_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL2_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PLL2_ON__", choice)
                end
        ...
        local function configure_PLL2_mul()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL2_MULL__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PLL2_MULL__", choice)
                end
        ...
        local function configure_PLL3_on()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL3_ON__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PLL3_ON__", choice)
                end
        ...
        local function configure_PLL3_mul()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_PLL3_MULL__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_PLL3_MULL__", choice)
                end
        ...
        local function configure_AHB_pre()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_AHB_PRE__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_AHB_PRE__", choice)
                end
        ...
        local function configure_APB1_pre()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_APB1_PRE__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_APB1_PRE__", choice)
                end
        ...
        local function configure_APB2_pre()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_APB2_PRE__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_APB2_PRE__", choice)
                end
        ...
        local function configure_ADC_pre()
                ...
                local choice = key_read(db.path.stm32f1.pll.flags, "__PLL_ADC_PRE__")
                ...
                choice = get_selection()
                if (can_be_saved(choice)) then
                        key_save(db.path.stm32f1.pll.flags, "__PLL_ADC_PRE__", choice)
                end
...
function pll:get_frequencies()
        return arch[db:get_arch()].get_frequencies()
end
...
function pll:configure()
        title("PLL module configuration for " .. db:get_cpu_name())
