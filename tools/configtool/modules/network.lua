...
local function load_controls()
        ...
        ui.SpinCtrl_adv_TCP_MSL:SetValue(tonumber(ct:key_read(config.project.key.NETWORK_TCP_MSL)))
...
local function save_configuration()
        ...
        ct:key_write(config.project.key.NETWORK_TCP_MSL, tostring(ui.SpinCtrl_adv_TCP_MSL:GetValue()))
...
local function create_TCP_options_widgets(parent)
        ...
        -- TCP_MSL
        ui.FlexGridSizer_adv_TCP:AddStaticText("TCP_MSL")
        ui.SpinCtrl_adv_TCP_MSL = wx.wxSpinCtrl(ui.Panel_adv_TCP, wx.wxNewId(), "", wx.wxDefaultPosition, wx.wxDefaultSize, 0, 100, 600000)
        ui.SpinCtrl_adv_TCP_MSL:SetToolTip("The maximum segment lifetime in milliseconds.")
        ui.SpinCtrl_adv_TCP_MSL:Connect(wx.wxEVT_COMMAND_TEXT_UPDATED, function() modified:yes() end)
        ui.FlexGridSizer_adv_TCP:Add(ui.SpinCtrl_adv_TCP_MSL, 1, wx.wxALL+wx.wxEXPAND+wx.wxALIGN_LEFT+wx.wxALIGN_CENTER_VERTICAL, 5)
