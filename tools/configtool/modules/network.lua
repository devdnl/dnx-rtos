...
--------------------------------------------------------------------------------
-- @brief  Event is called when TextCtrl value is changed
-- @param  None
-- @return None
--------------------------------------------------------------------------------
local function textctrl_changed()
        ui.Button_save:Enable(true)
end
...
function network:create_window(parent)
        if ui.window == nil then
                ...
                ui.TextCtrl_MAC0 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC0, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.StaticText1 = wx.wxStaticText(this, wx.wxID_ANY, ":", wx.wxDefaultPosition, wx.wxDefaultSize)
                ui.FlexGridSizer2:Add(ui.StaticText1, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 0)
                ui.TextCtrl_MAC1 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC1, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.StaticText2 = wx.wxStaticText(this, wx.wxID_ANY, ":", wx.wxDefaultPosition, wx.wxDefaultSize)
                ui.FlexGridSizer2:Add(ui.StaticText2, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 0)
                ui.TextCtrl_MAC2 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC2, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.StaticText3 = wx.wxStaticText(this, wx.wxID_ANY, ":", wx.wxDefaultPosition, wx.wxDefaultSize)
                ui.FlexGridSizer2:Add(ui.StaticText3, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 0)
                ui.TextCtrl_MAC3 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC3, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.StaticText4 = wx.wxStaticText(this, wx.wxID_ANY, ":", wx.wxDefaultPosition, wx.wxDefaultSize)
                ui.FlexGridSizer2:Add(ui.StaticText4, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 0)
                ui.TextCtrl_MAC4 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC4, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.StaticText5 = wx.wxStaticText(this, wx.wxID_ANY, ":", wx.wxDefaultPosition, wx.wxDefaultSize)
                ui.FlexGridSizer2:Add(ui.StaticText5, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 0)
                ui.TextCtrl_MAC5 = wx.wxTextCtrl(this, ID.TEXTCTRL_MAC5, "", wx.wxDefaultPosition, wx.wxSize(30,-1), 0, ct.hexvalidator)
                ...
                ui.ComboBox_if_path = wx.wxComboBox(this, ID.COMBOBOX_IF_PATH, "", wx.wxDefaultPosition, wx.wxDefaultSize, {}, 0)
                ...
                this:Connect(ID.TEXTCTRL_MAC0,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
                this:Connect(ID.TEXTCTRL_MAC1,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
                this:Connect(ID.TEXTCTRL_MAC2,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
                this:Connect(ID.TEXTCTRL_MAC3,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
                this:Connect(ID.TEXTCTRL_MAC4,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
                this:Connect(ID.TEXTCTRL_MAC5,    wx.wxEVT_COMMAND_TEXT_UPDATED,      textctrl_changed       )
