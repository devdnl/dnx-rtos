...
function operating_system:create_window(parent)
        if ui.window == nil then
                ...
                this:Connect(ID.SPINCTRL_TASK_STACK_SIZE,      wx.wxEVT_COMMAND_TEXT_UPDATED,     stack_value_changed )
                this:Connect(ID.SPINCTRL_FS_STACK_SIZE,        wx.wxEVT_COMMAND_SPINCTRL_UPDATED, stack_value_changed )
                this:Connect(ID.SPINCTRL_FS_STACK_SIZE,        wx.wxEVT_COMMAND_TEXT_UPDATED,     stack_value_changed )
                this:Connect(ID.SPINCTRL_INITD_STACK_SIZE,     wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_INITD_STACK_SIZE,     wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_IRQ_STACK_SIZE,       wx.wxEVT_COMMAND_SPINCTRL_UPDATED, stack_value_changed )
                this:Connect(ID.SPINCTRL_IRQ_STACK_SIZE,       wx.wxEVT_COMMAND_TEXT_UPDATED,     stack_value_changed )
                this:Connect(ID.SPINCTRL_NUMBER_OF_PRIORITIES, wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_NUMBER_OF_PRIORITIES, wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_TASK_NAME_LEN,        wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_TASK_NAME_LEN,        wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_SWITCH_FREQ,          wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_SWITCH_FREQ,          wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                ...
                this:Connect(ID.SPINCTRL_NET_MEM_LIMIT,        wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_STREAM_LEN,           wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_STREAM_LEN,           wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_PIPE_LEN,             wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_PIPE_LEN,             wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
                this:Connect(ID.SPINCTRL_MEM_BLOCK,            wx.wxEVT_COMMAND_SPINCTRL_UPDATED, value_changed       )
                this:Connect(ID.SPINCTRL_MEM_BLOCK,            wx.wxEVT_COMMAND_TEXT_UPDATED,     value_changed       )
