...
local function load_configuration()
        ui.CheckBox_enable:SetValue(ct:get_module_state("rtcm"))
end
...
local function save_configuration()
        ct:enable_module("rtcm", ui.CheckBox_enable:GetValue())
        modified:no()
end
...
--------------------------------------------------------------------------------
function rtcm:create_window(parent)
        ui = {}
