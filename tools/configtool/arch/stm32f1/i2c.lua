...
function i2c:create_window(parent)
        ...
        ui.Choice_I2C = wx.wxChoice(ui.Panel_module, ID.CHOICE_I2C, wx.wxDefaultPosition, wx.wxDefaultSize)
        ...
        ui.FlexGridSizer_settings:Add(ui.SpinCtrl_SCL_freq, 1, bit.bor(wx.wxALL,wx.wxALIGN_CENTER_HORIZONTAL,wx.wxALIGN_CENTER_VERTICAL), 5)
        ...
        ui.Choice_dev_no:Append({"1", "2", "3", "4", "5", "6", "7", "8", "9"})
        ...
        ui.FlexGridSizer_peripheral:Fit(ui.Panel_peripheral)
        ui.FlexGridSizer_peripheral:SetSizeHints(ui.Panel_peripheral)
