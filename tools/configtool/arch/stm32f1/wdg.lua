...
function wdg:create_window(parent)
        ...
        ui.CheckBox_lock:SetToolTip("When this option is selected then is not possible to open device from another task when it is already opened. Other words, by using this option only one task is able to control watchdog.")
