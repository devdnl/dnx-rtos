...
local cpu            = config.arch.stm32f1.cpulist:Children()[cpu_idx]
local cpu_family     = cpu.family:GetValue()
...
function afio:create_window(parent)
        ...
        ui.FlexGridSizer5:Fit(ui.Panel_CEO)
        ui.FlexGridSizer5:SetSizeHints(ui.Panel_CEO)
        ...
        ui.Choice_remap_SPI1:Append("No (NSS/PA15, SCK/PB3, MISO/PB4, MOSI/PB5)")
        ui.Choice_remap_SPI1:Append("Yes (NSS/PA4, SCK/PA5, MISO/PA6, MOSI/PA7)")
        ...
        ui.Choice_remap_I2C1:Append("No (SCL/PB8, SDA/PB9)")
        ui.Choice_remap_I2C1:Append("Yes (SCL/PB6, SDA/PB7)")
