...
local function on_button_save_click()
        wizcore:key_write(wizcore.PROJECT.KEY.OS_TASK_MIN_STACK_DEPTH, tostring(ui.SpinCtrl_task_stack_size:GetValue()))
        wizcore:key_write(wizcore.PROJECT.KEY.OS_FILE_SYSTEM_STACK_DEPTH, tostring(ui.SpinCtrl_fs_stack_size:GetValue()))
        wizcore:key_write(wizcore.PROJECT.KEY.OS_IRQ_STACK_DEPTH, tostring(ui.SpinCtrl_irq_stack_size:GetValue()))
