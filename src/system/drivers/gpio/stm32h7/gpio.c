...
static const struct GPIO_reg GPIOx[] = {
        ...
        {.GPIO = GPIOA, .IOPEN = RCC_AHB4ENR_GPIOAEN, .MODER = GPIOx_MODER(GPIOA), .OSPEEDR = GPIOx_OSPEEDR(GPIOA), .PUPDR = GPIOx_PUPDR(GPIOA), .AFRL = GPIOx_AFRL(GPIOA), .AFRH = GPIOx_AFRH(GPIOA), .OTYPER = GPIOx_OTYPER(GPIOA), .ODR = GPIOx_ODR(GPIOA)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOBEN)
        {.GPIO = GPIOB, .IOPEN = RCC_AHB4ENR_GPIOBEN, .MODER = GPIOx_MODER(GPIOB), .OSPEEDR = GPIOx_OSPEEDR(GPIOB), .PUPDR = GPIOx_PUPDR(GPIOB), .AFRL = GPIOx_AFRL(GPIOB), .AFRH = GPIOx_AFRH(GPIOB), .OTYPER = GPIOx_OTYPER(GPIOB), .ODR = GPIOx_ODR(GPIOB)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOCEN)
        {.GPIO = GPIOC, .IOPEN = RCC_AHB4ENR_GPIOCEN, .MODER = GPIOx_MODER(GPIOC), .OSPEEDR = GPIOx_OSPEEDR(GPIOC), .PUPDR = GPIOx_PUPDR(GPIOC), .AFRL = GPIOx_AFRL(GPIOC), .AFRH = GPIOx_AFRH(GPIOC), .OTYPER = GPIOx_OTYPER(GPIOC), .ODR = GPIOx_ODR(GPIOC)},
        #endif
        #if defined(RCC_AHB4ENR_GPIODEN)
        {.GPIO = GPIOD, .IOPEN = RCC_AHB4ENR_GPIODEN, .MODER = GPIOx_MODER(GPIOD), .OSPEEDR = GPIOx_OSPEEDR(GPIOD), .PUPDR = GPIOx_PUPDR(GPIOD), .AFRL = GPIOx_AFRL(GPIOD), .AFRH = GPIOx_AFRH(GPIOD), .OTYPER = GPIOx_OTYPER(GPIOD), .ODR = GPIOx_ODR(GPIOD)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOEEN)
        {.GPIO = GPIOE, .IOPEN = RCC_AHB4ENR_GPIOEEN, .MODER = GPIOx_MODER(GPIOE), .OSPEEDR = GPIOx_OSPEEDR(GPIOE), .PUPDR = GPIOx_PUPDR(GPIOE), .AFRL = GPIOx_AFRL(GPIOE), .AFRH = GPIOx_AFRH(GPIOE), .OTYPER = GPIOx_OTYPER(GPIOE), .ODR = GPIOx_ODR(GPIOE)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOFEN)
        {.GPIO = GPIOF, .IOPEN = RCC_AHB4ENR_GPIOFEN, .MODER = GPIOx_MODER(GPIOF), .OSPEEDR = GPIOx_OSPEEDR(GPIOF), .PUPDR = GPIOx_PUPDR(GPIOF), .AFRL = GPIOx_AFRL(GPIOF), .AFRH = GPIOx_AFRH(GPIOF), .OTYPER = GPIOx_OTYPER(GPIOF), .ODR = GPIOx_ODR(GPIOF)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOGEN)
        {.GPIO = GPIOG, .IOPEN = RCC_AHB4ENR_GPIOGEN, .MODER = GPIOx_MODER(GPIOG), .OSPEEDR = GPIOx_OSPEEDR(GPIOG), .PUPDR = GPIOx_PUPDR(GPIOG), .AFRL = GPIOx_AFRL(GPIOG), .AFRH = GPIOx_AFRH(GPIOG), .OTYPER = GPIOx_OTYPER(GPIOG), .ODR = GPIOx_ODR(GPIOG)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOHEN)
        {.GPIO = GPIOH, .IOPEN = RCC_AHB4ENR_GPIOHEN, .MODER = GPIOx_MODER(GPIOH), .OSPEEDR = GPIOx_OSPEEDR(GPIOH), .PUPDR = GPIOx_PUPDR(GPIOH), .AFRL = GPIOx_AFRL(GPIOH), .AFRH = GPIOx_AFRH(GPIOH), .OTYPER = GPIOx_OTYPER(GPIOH), .ODR = GPIOx_ODR(GPIOH)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOIEN)
        {.GPIO = GPIOI, .IOPEN = RCC_AHB4ENR_GPIOIEN, .MODER = GPIOx_MODER(GPIOI), .OSPEEDR = GPIOx_OSPEEDR(GPIOI), .PUPDR = GPIOx_PUPDR(GPIOI), .AFRL = GPIOx_AFRL(GPIOI), .AFRH = GPIOx_AFRH(GPIOI), .OTYPER = GPIOx_OTYPER(GPIOI), .ODR = GPIOx_ODR(GPIOI)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOJEN)
        {.GPIO = GPIOJ, .IOPEN = RCC_AHB4ENR_GPIOJEN, .MODER = GPIOx_MODER(GPIOJ), .OSPEEDR = GPIOx_OSPEEDR(GPIOJ), .PUPDR = GPIOx_PUPDR(GPIOJ), .AFRL = GPIOx_AFRL(GPIOJ), .AFRH = GPIOx_AFRH(GPIOJ), .OTYPER = GPIOx_OTYPER(GPIOJ), .ODR = GPIOx_ODR(GPIOJ)},
        #endif
        #if defined(RCC_AHB4ENR_GPIOKEN)
        {.GPIO = GPIOK, .IOPEN = RCC_AHB4ENR_GPIOKEN, .MODER = GPIOx_MODER(GPIOK), .OSPEEDR = GPIOx_OSPEEDR(GPIOK), .PUPDR = GPIOx_PUPDR(GPIOK), .AFRL = GPIOx_AFRL(GPIOK), .AFRH = GPIOx_AFRH(GPIOK), .OTYPER = GPIOx_OTYPER(GPIOK), .ODR = GPIOx_ODR(GPIOK)},
        #endif
};
...
API_MOD_INIT(GPIO, void **device_handle, u8_t major, u8_t minor, const void *config)
{
        ...
        if (major < ARRAY_SIZE(GPIOx) && minor == 0) {
                SET_BIT(RCC->AHB4ENR, GPIOx[major].IOPEN);
...
API_MOD_RELEASE(GPIO, void *device_handle)
{
        ...
        CLEAR_BIT(RCC->AHB4ENR, hdl->IOPEN);
        SET_BIT(RCC->AHB4RSTR, hdl->IOPEN);
        CLEAR_BIT(RCC->AHB4RSTR, hdl->IOPEN);
...
API_MOD_IOCTL(GPIO, void *device_handle, int request, void *arg)
{
        ...
        if (arg) {
                ...
                case IOCTL_GPIO__SET_PIN_STATE_IN_PORT: {
                        ...
                        if ((pin->pin.port_idx < ARRAY_SIZE(GPIOx)) && (pin->pin.pin_idx < 16)) {
                                if (pin->state) {
                                        GPIOx[pin->pin.port_idx].GPIO->BSRR = (1 << pin->pin.pin_idx);
                                } else {
                                        GPIOx[pin->pin.port_idx].GPIO->BSRR = (1 << (pin->pin.pin_idx + 16));
                                }
                                err = ESUCC;
                        }
                        break;
                ...
                case IOCTL_GPIO__GET_PIN_STATE_IN_PORT: {
                        GPIO_pin_in_port_state_t *pin = arg;
                        if ((pin->pin.port_idx < ARRAY_SIZE(GPIOx)) && (pin->pin.pin_idx < 16)) {
                                pin->state = (GPIOx[pin->pin.port_idx].GPIO->IDR & (1 << pin->pin.pin_idx)) ? 1 : 0;
                                err = ESUCC;
                        }
                        break;
                }
