...
#define PHY_100BTX_FULL                 ((1 * ETHMAC_PHY_DUPLEX_STATUS_BM) | (0 * ETHMAC_PHY_SPEED_STATUS_BM))
#define PHY_100BTX_HALF                 ((0 * ETHMAC_PHY_DUPLEX_STATUS_BM) | (0 * ETHMAC_PHY_SPEED_STATUS_BM))
#define PHY_10M_FULL                    ((1 * ETHMAC_PHY_DUPLEX_STATUS_BM) | (1 * ETHMAC_PHY_SPEED_STATUS_BM))
#define PHY_10M_HALF                    ((0 * ETHMAC_PHY_DUPLEX_STATUS_BM) | (1 * ETHMAC_PHY_SPEED_STATUS_BM))
