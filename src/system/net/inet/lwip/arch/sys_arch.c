...
void *sys_malloc(size_t blksz)
{
        ...
        if (_kmalloc(_MM_NET, blksz, NULL, _MM_FLAG__DMA_CAPABLE, _MM_FLAG__DMA_CAPABLE, &mem) == 0) {
                return mem;
        } else {
                return NULL;
        }
...
void *sys_calloc(size_t n, size_t blksz)
{
        ...
        if (_kzalloc(_MM_NET, blksz * n, NULL, _MM_FLAG__DMA_CAPABLE, _MM_FLAG__DMA_CAPABLE, &mem) == 0) {
                return mem;
        } else {
                return NULL;
        }
