...
{
        return _kmalloc(_MM_FS, size, NULL, _MM_FLAG__DMA_CAPABLE, _MM_FLAG__DMA_CAPABLE, mem);
}
...
{
        return _kzalloc(_MM_FS, size, NULL, _MM_FLAG__DMA_CAPABLE, _MM_FLAG__DMA_CAPABLE, mem);
}
