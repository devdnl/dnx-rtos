...
typedef struct {
        u16_t sec1;                     //!< average CPU laod within 1 second (1% = 10)
        u16_t min1;                     //!< average CPU load within 1 minute (1% = 10)
        u16_t min5;                     //!< average CPU load within 5 minutes (1% = 10)
        u16_t min15;                    //!< average CPU load within 15 minutes (1% = 10)
} avg_CPU_load_t;
...
extern sem_t      *_process_get_syscall_sem         (task_t*);
