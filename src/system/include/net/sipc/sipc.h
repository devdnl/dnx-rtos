...
extern int   SIPC_socket_recvfrom(void*, SIPC_socket_t*, void*, size_t, NET_flags_t, NET_SIPC_sockaddr_t*, size_t*);
extern int   SIPC_socket_send(void*, SIPC_socket_t*, const void*, size_t, NET_flags_t, size_t*);
extern int   SIPC_socket_sendto(void*, SIPC_socket_t*, const void*, size_t, NET_flags_t, const NET_SIPC_sockaddr_t*, size_t*);
extern int   SIPC_gethostbyname(void*, const char*, NET_SIPC_sockaddr_t*);
...
extern int   SIPC_socket_getaddress(void*, SIPC_socket_t*, NET_SIPC_sockaddr_t*);
