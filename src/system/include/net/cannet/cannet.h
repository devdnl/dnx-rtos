...
extern int   CANNET_ifup(void*, const NET_CANNET_config_t*, size_t);
extern int   CANNET_ifdown(void*);
extern int   CANNET_ifstatus(void*, NET_CANNET_status_t*, size_t);
extern int   CANNET_socket_create(void*, NET_protocol_t, CANNET_socket_t*);
extern int   CANNET_socket_destroy(void*, CANNET_socket_t*);
extern int   CANNET_socket_connect(void*, CANNET_socket_t*, const NET_CANNET_sockaddr_t*, size_t);
...
extern int   CANNET_socket_bind(void*, CANNET_socket_t*, const NET_CANNET_sockaddr_t*, size_t);
...
extern int   CANNET_socket_recvfrom(void*, CANNET_socket_t*, void*, size_t, NET_flags_t, NET_CANNET_sockaddr_t*, size_t, size_t*);
extern int   CANNET_socket_send(void*, CANNET_socket_t*, const void*, size_t, NET_flags_t, size_t*);
extern int   CANNET_socket_sendto(void*, CANNET_socket_t*, const void*, size_t, NET_flags_t, const NET_CANNET_sockaddr_t*, size_t, size_t*);
extern int   CANNET_gethostbyname(void*, const char*, NET_CANNET_sockaddr_t*, size_t);
...
extern int   CANNET_socket_getaddress(void*, CANNET_socket_t*, NET_CANNET_sockaddr_t*, size_t);
