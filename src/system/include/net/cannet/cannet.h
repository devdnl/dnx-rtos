...
typedef struct CANNET_socket {
        ...
        u16_t expected_crc;
        u16_t crc;
        NETM_protocol_t protocol;
        NETM_shut_t shutdown;
        u8_t port;
        u8_t seq_tx;
        u8_t seq_rx;
        bool connected;
...
extern int   CANNET_ifup(void*, const NETM_CANNET_config_t*, size_t);
extern int   CANNET_ifdown(void*);
extern int   CANNET_ifstatus(void*, NETM_CANNET_status_t*, size_t);
extern int   CANNET_socket_create(void*, NETM_protocol_t, CANNET_socket_t*);
extern int   CANNET_socket_destroy(void*, CANNET_socket_t*);
extern int   CANNET_socket_connect(void*, CANNET_socket_t*, const NETM_CANNET_sockaddr_t*, size_t);
extern int   CANNET_socket_disconnect(void*, CANNET_socket_t*);
extern int   CANNET_socket_shutdown(void*, CANNET_socket_t*, NETM_shut_t);
extern int   CANNET_socket_bind(void*, CANNET_socket_t*, const NETM_CANNET_sockaddr_t*, size_t);
extern int   CANNET_socket_listen(void*, CANNET_socket_t*);
extern int   CANNET_socket_accept(void*, CANNET_socket_t*, CANNET_socket_t*);
extern int   CANNET_socket_recv(void*, CANNET_socket_t*, void*, size_t, NETM_flags_t, size_t*);
extern int   CANNET_socket_recvfrom(void*, CANNET_socket_t*, void*, size_t, NETM_flags_t, NETM_CANNET_sockaddr_t*, size_t, size_t*);
extern int   CANNET_socket_send(void*, CANNET_socket_t*, const void*, size_t, NETM_flags_t, size_t*);
extern int   CANNET_socket_sendto(void*, CANNET_socket_t*, const void*, size_t, NETM_flags_t, const NETM_CANNET_sockaddr_t*, size_t, size_t*);
extern int   CANNET_gethostbyname(void*, const char*, NETM_CANNET_sockaddr_t*, size_t);
...
extern int   CANNET_socket_getaddress(void*, CANNET_socket_t*, NETM_CANNET_sockaddr_t*, size_t);
