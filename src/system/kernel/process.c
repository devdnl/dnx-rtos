...
//        _vfs_ioctl(data->f_stdout, IOCTL_VFS__DEFAULT_RD_MODE); TODO
//        _vfs_ioctl(data->f_stdout, IOCTL_VFS__DEFAULT_WR_MODE); TODO
//        _vfs_ioctl(data->f_stderr, IOCTL_VFS__DEFAULT_RD_MODE); TODO
//        _vfs_ioctl(data->f_stderr, IOCTL_VFS__DEFAULT_WR_MODE); TODO
}
