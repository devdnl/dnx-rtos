...
//==============================================================================
/**
 * @brief Convert unicode to OEMCP or vice versa
 *
 * @param[in] chr       Character code to be converted
 * @param[in] dir       0: Unicode to OEMCP, 1: OEMCP to Unicode
 *
 * @return wide character or 0 if error
 */
//==============================================================================
wchar_t _libfat_convert(wchar_t chr, uint dir)
{
        const wchar_t *p;
        wchar_t c;
        int i, n, li, hi;
...
//==============================================================================
/**
 * @brief Upper converted character
 *
