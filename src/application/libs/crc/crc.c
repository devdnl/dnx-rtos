...
/*==============================================================================
  Exported objects
==============================================================================*/
const uint16_t crc16_ccitt_init = 0xFFFF;
const uint32_t crc32_ethernet_init = 0xFFFFFFFF;
 ...
 */
//==============================================================================
uint16_t crc16_udpate_ccitt(const void *buf, uint16_t len, uint16_t crc_in)
{
        const uint8_t *b = buf;
 ...
 */
//==============================================================================
uint32_t crc32_update(const void *buf, uint32_t buflen, uint32_t init)
{
        uint32_t crc = init;
        const uint8_t *b = buf;
