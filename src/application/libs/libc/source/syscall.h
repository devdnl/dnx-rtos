...
typedef enum {
        ...
        _LIBC_SYS_SEMAPHOREOPEN,          // int errno (const size_t *cnt_max, const size_t *cnt_init, int *fd, int *flags)
        ...
        _LIBC_SYS_MUTEXOPEN,              // int errno (const enum kmtx_type *mt, int *fd, int *flags)
        ...
        _LIBC_SYS_QUEUEOPEN,              // int errno (const size_t *length, const size_t *item_size, int *fd, int *flags)
